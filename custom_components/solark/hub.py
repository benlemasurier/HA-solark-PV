...
class SolArkModbusHub(DataUpdateCoordinator[dict]):
    ...
    def read_modbus_realtime_data(self) -> dict:
        ...
        if not realtime_data.isError():
            ...
            data["dailyload_e"] = decoder.decode_16bit_uint() / 10.0
        ...
        if not realtime_data.isError():
            ...
            # R98
            data["totalinv_e"] = decoder.decode_32bit_int() / 10.0
            decoder.skip_bytes(10)

            # R103
            flt = decoder.decode_32bit_uint()
        ...
        if not realtime_data.isError():
            ...
            # R150
            data["gridl1n_v"] = decoder.decode_16bit_uint() / 10.0
            ...
            # R160
            data["gridl1_c"] = decoder.decode_16bit_int() / 100.0
            ...
            # R170
            data["gridlmtl1_p"] = decoder.decode_16bit_int()
            updated = True
        ...
        if not realtime_data.isError():
            ...
            # R171
            data["gridlmtl2_p"] = decoder.decode_16bit_int()
            ...
            # R181
            data["genl1l2_v"] = decoder.decode_16bit_uint() / 10.0
